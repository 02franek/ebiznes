...
func TestGetProductsAPI_Success(t *testing.T) {
	router := setupRouter()
...
func TestGetProductsAPIMethodNotAllowed(t *testing.T) {
	router := setupRouter()
...
func TestPostPaymentsAPI_Success(t *testing.T) {
	router := setupRouter()
...
func TestPostPaymentsAPI_NegativeOrZeroAmount(t *testing.T) {
	router := setupRouter()
